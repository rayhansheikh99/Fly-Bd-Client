...
const Login = () => {
  ...
  const { handleSignIn, handleEmailChange, loginWithGoogle, handlePasswordChange} = useFirebase();
    ...
    return (
        <div className='page-size'>
            <Form className='' onSubmit={handleSignIn}>
              ...
              <p onClick={loginWithGoogle} className='google-sign me-4'>Sign Up with Google</p>
